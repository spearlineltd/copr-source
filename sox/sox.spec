...
Source0: https://yhbt.net/sox.git/snapshot/%{name}-%{version}.tar.gz
...
BuildRequires: gcc
BuildRequires: alsa-lib-devel, libtool-ltdl-devel
BuildRequires: libid3tag-devel, lame-devel, gsm-devel
BuildRequires: speex-devel speexdsp-devel, spandsp-devel
...
%changelog
* Wed Jan 29 2020 Jiri Kucera <jkucera@redhat.com> - 14.4.2.0-29
- backport fix of CVE-2017-18189 (rhbz#1545867)
